...
class MotionBlur:
    def __init__(self, prob):
        self.aug = augmentations.MotionBlur(
            blur_limit=5, p=prob)
...
class GlassBlur:
    def __init__(self, prob):
        self.aug = augmentations.GlassBlur(
...
class Blur:
    def __init__(self, prob):
        self.aug = augmentations.Blur(p=prob)
...
class GridDistortion:
    def __init__(self, prob):
        self.aug = augmentations.GridDistortion(p=prob)
...
class OpticalDistortion:
    def __init__(self, prob):
        self.aug = augmentations.OpticalDistortion(
...
class MedianBlur:
    def __init__(self, prob):
        self.aug = augmentations.MedianBlur(
            blur_limit=3, p=prob)
